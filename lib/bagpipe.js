...
var addToQueue = function(unshift) {
  if (this.stopped)
  {
    console.log('NOT INSETING BECAUSE IT IS STOPPED !!!');
    return () => {};
  }
...
Bagpipe.prototype.resume = function() { this.paused = false; if (!this.stopped) this.next(); };

Bagpipe.prototype.stop = function() { this.stopped = true; this.queue = []; this.active = 0; this.paused = true; };
Bagpipe.prototype.start = function() { this.stopped = false; this.paused = false; };
